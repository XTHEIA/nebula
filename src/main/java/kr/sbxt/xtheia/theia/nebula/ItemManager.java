...
public class ItemManager {
	...
	public static final NamespacedKey KEY_METAUID = new NamespacedKey(Nebula.plugin, "METAITEMS_METAUID");
	public static final NamespacedKey KEY_CODENAME = new NamespacedKey(Nebula.plugin, "METAITEMS_CODENAME");
